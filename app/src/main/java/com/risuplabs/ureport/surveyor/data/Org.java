package com.risuplabs.ureport.surveyor.data;
...
import com.risuplabs.ureport.surveyor.engine.OrgAssets;
...
public class Org {
    ...
    public transient List<com.risuplabs.ureport.surveyor.net.responses.Flow> flowTitles;
    ...
    public void refresh(boolean includeAssets, RefreshProgress progress) throws TembaException, IOException {
        ...
        com.risuplabs.ureport.surveyor.net.responses.Org apiOrg = svc.getOrg(this.token);
    ...
    public void download(boolean includeAssets, RefreshProgress progress, List<com.risuplabs.ureport.surveyor.net.responses.Flow> flows) throws TembaException, IOException {
        TembaService svc = SurveyorApplication.get().getTembaService();
        com.risuplabs.ureport.surveyor.net.responses.Org apiOrg = svc.getOrg(this.token);
    ...
    private void refreshAssets(RefreshProgress progress) throws TembaException, IOException {
        ...
        List<com.risuplabs.ureport.surveyor.net.responses.Flow> flows = SurveyorApplication.get().getTembaService().getFlows(getToken());

        progress.reportProgress(50);

        List<com.risuplabs.ureport.surveyor.net.responses.Flow> filtered_flows = SurveyorApplication.get().getTembaService().get_filtered_flow(flows);
    ...
    public void downloadAssets(RefreshProgress progress, List<com.risuplabs.ureport.surveyor.net.responses.Flow> filtered_flows) throws TembaException, IOException {
