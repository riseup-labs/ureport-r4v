...
import com.risuplabs.ureport.adapter.CustomScrollAdapter;
import com.risuplabs.ureport.base.BaseActivity;
import com.risuplabs.ureport.databinding.ActivityMainBinding;
import com.risuplabs.ureport.model.dashboard.ModelDashboardListRV;
...
public class DashBoardActivity extends BaseActivity<ActivityMainBinding> implements CustomScrollAdapter.ClickListener {
    ...
    public void onViewReady(@Nullable Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onViewReady: "+prefManager.getString(SurveyorPreferences.SAVED_UUID));
