...
import com.risuplabs.ureport.databinding.ActivityFlowListBinding;
...
import com.risuplabs.ureport.surveyor.task.RefreshOrgTask;
...
import com.risuplabs.ureport.utils.custom_dialog.CustomDialogComponent;
...
//                showBugReportDialog();
    ...
    public void download(List<com.risuplabs.ureport.surveyor.net.responses.Flow> flows) {
        final BlockingProgress progressModal = new BlockingProgress(FlowListActivity.this, R.string.one_moment, R.string.refresh_org);
        progressModal.setOnDismissListener(dialogInterface -> {
            ((SwipeRefreshLayout) flowListFragment.requireView().findViewById(R.id.flowRefreshLayout)).setRefreshing(false);
            donx.cancel(true);
    ...
    public void downloadAlert(){
        ...
        List<com.risuplabs.ureport.surveyor.net.responses.Flow> selected_flows = new ArrayList<>();
        List<com.risuplabs.ureport.surveyor.net.responses.Flow> bot_flows = new ArrayList<>();
        List<com.risuplabs.ureport.surveyor.net.responses.Flow> poll_flows = new ArrayList<>();
