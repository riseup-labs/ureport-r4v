...
public class PollGenderChildAdapter extends BaseRecyclerViewAdapter<ModelQuestionCategory, ItemPollStatisticsProgressbarBinding> {

    Context context;
    int set;

    public PollGenderChildAdapter(Context context, int set) {
