package com.riseuplabs.ureport_r4v.surveyor.data;

import com.google.gson.annotations.SerializedName;
import com.google.gson.reflect.TypeToken;
import com.riseuplabs.ureport_r4v.di.SurveyorApplication;
import com.riseuplabs.ureport_r4v.surveyor.engine.OrgAssets;
...
public class Org {
    ...
    public transient List<com.riseuplabs.ureport_r4v.surveyor.net.responses.Flow> flowTitles;
    ...
    public void refresh(boolean includeAssets, RefreshProgress progress) throws TembaException, IOException {
        ...
        com.riseuplabs.ureport_r4v.surveyor.net.responses.Org apiOrg = svc.getOrg(this.token);
    ...
    public void download(boolean includeAssets, RefreshProgress progress, List<com.riseuplabs.ureport_r4v.surveyor.net.responses.Flow> flows,String type) throws TembaException, IOException {
        TembaService svc = SurveyorApplication.get().getTembaService();
        com.riseuplabs.ureport_r4v.surveyor.net.responses.Org apiOrg = svc.getOrg(this.token);
    ...
    private void refreshAssets(RefreshProgress progress) throws TembaException, IOException {
        ...
        List<com.riseuplabs.ureport_r4v.surveyor.net.responses.Flow> flows = SurveyorApplication.get().getTembaService().getFlows(getToken());

        progress.reportProgress(50);

        List<com.riseuplabs.ureport_r4v.surveyor.net.responses.Flow> filtered_flows = SurveyorApplication.get().getTembaService().get_filtered_flow(flows);
    ...
    public void downloadAssets(RefreshProgress progress, List<com.riseuplabs.ureport_r4v.surveyor.net.responses.Flow> filtered_flows, String type) throws TembaException, IOException {
